...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<?php echo $base_url; ?>/assets/img/logo.png?v=<?php echo time(); ?>" type="image/png">
    <link rel="apple-touch-icon" href="<?php echo $base_url; ?>/assets/img/logo.png?v=<?php echo time(); ?>">
