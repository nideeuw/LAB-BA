                        ...
                        <form action="<?php echo $base_url; ?>/cms/roadmap/store" method="POST" id="roadmapForm">
                            ...
                            <div class="row">
                                <div class="col-md-8 mb-4">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" required placeholder="e.g., Jangka Pendek (1–5 Tahun)">
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="content" name="content" rows="10" required placeholder="Enter roadmap content..."></textarea>
