                    ...
                    <div class="card-body">
                        <form action="<?php echo $base_url; ?>/cms/publications/store" method="POST" id="publicationForm">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="title" name="title" rows="3" required placeholder="Enter publication title"></textarea>
                            </div>

                            <div class="mb-4">
                                <label for="journal_name" class="form-label fw-semibold">Journal Name</label>
                                <input type="text" class="form-control" id="journal_name" name="journal_name" placeholder="e.g., IEEE Transactions, Nature, etc.">
                            </div>

                            <div class="mb-4">
                                <label for="year" class="form-label fw-semibold">Year <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="year" name="year" required min="1900" max="<?php echo date('Y') + 1; ?>" value="<?php echo date('Y'); ?>">
                            </div>

                            <div class="mb-4">
                                <label for="journal_link" class="form-label fw-semibold">Journal Link</label>
                                <input type="url" class="form-control" id="journal_link" name="journal_link" placeholder="https://doi.org/...">
                                <div class="form-text">Full URL to the publication (DOI, journal website, etc.)</div>
                            </div>

                            <div class="mb-4">
                                <label for="kategori_publikasi" class="form-label fw-semibold">Publication Category</label>
                                <input type="text" class="form-control" id="kategori_publikasi" name="kategori_publikasi" placeholder="e.g., Journal, Conference, Book Chapter">
