                    ...
                    <div class="card-body">
                        <form action="<?php echo $base_url; ?>/cms/contact/store" method="POST" id="contactForm">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email" class="form-control" id="email" name="email" required placeholder="laboratoriumBA@polinema.ac.id">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="alamat" name="alamat" rows="3" required placeholder="Jl. Soekarno Hatta No. 9 Malang, Jawa Timur 65141"></textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="no_telp" name="no_telp" required placeholder="+62 341 123456">
