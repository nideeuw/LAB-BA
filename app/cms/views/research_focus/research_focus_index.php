...
/**
 * Research Focus List View
 * File: app/cms/views/research_focus/research_focus_index.php
 */
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="researchFocusTable" class="table table-hover">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Title</th>
...
$(document).ready(function() {
    $("#researchFocusTable").DataTable({
        order: [[3, "asc"]], // Sort by sort_order ascending
        pageLength: 25,
        language: {
            search: "Search research focus:",
