                        ...
                        <form method="POST" action="<?php echo $base_url; ?>/cms/research_focus/update/<?php echo $focus['id']; ?>">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title" required
                                    value="<?php echo htmlspecialchars($focus['title']); ?>">
                            </div>

                            <div class="mb-3">
                                <label for="sort_order" class="form-label">Sort Order <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="sort_order" name="sort_order"
                                    value="<?php echo $focus['sort_order']; ?>" required min="1">
                                <small class="text-muted">Lower numbers appear first</small>
                            </div>

                            <div class="mb-3">
                                <label for="focus_description" class="form-label">Focus Description <span class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                <label for="examples" class="form-label">Examples <span class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                                        <?php echo $focus['is_active'] ? 'checked' : ''; ?>>
