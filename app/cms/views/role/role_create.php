                    ...
                    <div class="card-body">
                        <form action="<?php echo $base_url; ?>/cms/role/store" method="POST" id="roleForm">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control text-uppercase" id="role_code" name="role_code" required maxlength="50" placeholder="e.g., ADMIN, STAFF, MEMBER" style="text-transform: uppercase;">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="role_name" name="role_name" required maxlength="100" placeholder="e.g., Administrator, Staff Member">
